var AppConfig = {
	apiUrl : "http://imapi.shiku.co",// 接口地址（修改“114.119.6.150”即可）
	boshDomain : "im.shiku.co",// XMPP主机IP或域名
	mucJID : "muc.im.shiku.co",// muc.+XMPP主机IP或域名
	boshUrl : "http://im.shiku.co:5280",// http://+（XMPP主机IP或域名）+（:5280）
	meetingHost:"119.23.79.36",//音视频通话 会议 服务器地址
	uploadAvatarUrl : "http://upload.shiku.co/upload/UploadifyAvatarServlet",// 头像上传URL（修改“www.shiku.co”即可）
	uploadUrl : "http://upload.shiku.co/upload/UploadifyServlet",// 文件上传URL（修改“www.shiku.co”即可）
	deleteFileUrl:"http://upload.shiku.co/upload/deleteFileServlet",//删除文件接口
	defaultAvatarUrl :"http://file.shiku.co/avatar/t/104/10000104.jpg",// 默认头像地址（）
	avatarBase : "http://file.shiku.co/avatar/o/",// 头像父目录（修改“file.shiku.co”即可）
	defAvatar : 'http://file.shiku.co/image/ic_avatar.png'
}
...
var myFn = {
	...
	getAvatarUrl : function(userId) {
		...
		var imgUrl = $("#imgurl").html();/*AppConfig.avatarBase + (parseInt(userId) % 10000) + "/" + userId + ".jpg"+"?x="+Math.random()*10;*/
		return imgUrl;
	},
